...
@Model.register("bigram_embedder")
class BigramEmbedder(Model):
    """
    ...
    def __init__(self, vocab: Vocabulary,
        ...
        super(BigramEmbedder, self).__init__(vocab, regularizer)
    ...
    def forward(self,  # type: ignore
        ...
        bigram_vecs_hat = self.mapping_layer(torch.cat([word1_vector, word2_vector], dim=-1))
